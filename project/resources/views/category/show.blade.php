...
@section('title')
    @parent - {{ $newsList[0]['category'] }}
@endsection

@section('header')
    <h1 class="fw-bolder">{{ $newsList[0]['category'] }}</h1>
@endsection
        ...
        <div class="col-lg-6">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="small text-muted"><a href="{{ route('category.show', ['id' => $news['category_id']]) }}">{{ $news['category'] }}</a></div>
